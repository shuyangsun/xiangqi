...
std::array<Position, 5> PossibleMovesGeneral(const Board& board, Position pos,
                                             Position opponent_general);

// Advisor can move to at most 2 positions. Impossible positions are filled with
// kNoPosition.
std::array<Position, 4> PossibleMovesAdvisor(const Board& board, Position pos);

// Elephant can move to at most 4 positions. Impossible positions are filled
// with kNoPosition.
std::array<Position, 4> PossibleMovesElephant(const Board& board, Position pos);

// Horse can move to at most 8 positions. Impossible positions are filled with
// kNoPosition.
std::array<Position, 8> PossibleMovesHorse(const Board& board, Position pos);

// Chariot can move to at most 17 positions (8 + 9). Impossible positions are
// filled with kNoPosition.
std::array<Position, 17> PossibleMovesChariot(const Board& board, Position pos);

// Cannon can move to at most 17 positions (8 + 9). Impossible positions are
// filled with kNoPosition.
std::array<Position, 17> PossibleMovesCannon(const Board& board, Position pos);

// Soldier can move to at most 3 positions. Impossible positions are filled with
// kNoPosition.
std::array<Position, 3> PossibleMovesSoldier(const Board& board, Position pos);
